...
CONTAINER_NAME_PROD = ${SERVICE_NAME}-${USR}-product
CONTAINER_NAME_DEV = ${SERVICE_NAME}-${USR}-dev
CONTAINER_NAME_RESERACH = ${SERVICE_NAME}-${USR}-research
...
ENV_TEXT = "$\
	...
	CONTAINER_NAME_PROD=${CONTAINER_NAME_PROD}\n$\
	CONTAINER_NAME_DEV=${CONTAINER_NAME_DEV}\n$\
	CONTAINER_NAME_RESERACH=${CONTAINER_NAME_RESERACH}\n$\
